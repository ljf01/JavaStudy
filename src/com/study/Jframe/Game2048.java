...
public class Game2048 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < x; i++) {
            for(int j = 0;j<y;j++) {
                JLabel backgroundLabel = new JLabel(new ImageIcon("src/com/study/imag/2048img/"+imgArray[i][j]+".png"));
        ...
        //设置背景图片
        //设置背景图
        JLabel backImg = new JLabel(new ImageIcon("src/com/study/imag/2048img/backgroup.png"));
